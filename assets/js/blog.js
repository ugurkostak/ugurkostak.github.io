...
(function () {
  ...
  function detectPage() {
    ...
    if (path.includes('algorithmic-art')) return 'algorithmic-art';
    return null;
  }
  ...
  function getMetadataPath() {
    ...
    const pathMap = {
      ...
      'algorithmic-art': './algorithmic-art/metadata.json'
    };
  ...
  function init() {
    ...
    if (page === 'tech-blog' || page === 'cinema' || page === 'photography' || page === 'algorithmic-art') {
